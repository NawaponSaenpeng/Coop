    ...
    public void ScoreCalculationCase(GetScore get) //enum
    {
        switch (get)
        {
            case GetScore.Miss:
                ...
                Instantiate(missEffect, new Vector3(-7.2f, -3.4f, 0f), Quaternion.identity);
                break;
            ...
            case GetScore.Good:
                ...
                Instantiate(goodEffect, new Vector3(-7.2f, -3.4f, 0f), Quaternion.identity);
                break;
            ...
            case GetScore.Perfect:
                ...
                Instantiate(perfectEffect, new Vector3(-7.2f, -3.4f, 0f), Quaternion.identity);
                break;
            ...
            case GetScore.Bad:
                ...
                Instantiate(badEffect, new Vector3(-7.2f, -3.4f, 0f), Quaternion.identity);
                break;
